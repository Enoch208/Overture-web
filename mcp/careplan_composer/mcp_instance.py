...
mcp.tool(name="ValidateAndWriteCarePlan", description="Validates a CarePlan against US Core and writes it to FHIR in one step. Returns validation result and new resource id.")(validate_and_write_care_plan)
